...
SCENARIO("Empty List Check"){
	GIVEN("Empty list of type int") {
		...
		cop3530::List<int> * list  = new cop3530::CBL<int>();
...
SCENARIO("One element list check") {
	GIVEN( "List with only one element of type string in it ") {
		...
		cop3530::List<std::string> *list = new cop3530::CBL<std::string>();
...
//
// 		// make copies
// 		CBL<int> new_list_0 = og_list_0;
// 		std::cout << "Made list 0" << std::endl;
// 		CBL<int> new_list_50 = og_list_50;
// 		std::cout << "Made list 50" << std::endl;
// 		CBL<int> new_list_51 = og_list_51;
// 		std::cout << "Made list 51" << std::endl;
//
// 		// test that the copies are as they should be
// 		THEN("Length should be respectively correct") {
// 			REQUIRE(new_list_0.length() == 0);
// 			REQUIRE(new_list_50.length() == 50);
// 			REQUIRE(new_list_51.length() == 51);
// 		}
//
// 		WHEN("Checking their items") {
// 			THEN("Items should be as instantiated for length of 50 and 51") {
// 				for(int i = 0; i < 50 ; ++i) {
// 					REQUIRE(new_list_50.item_at(i) == i);
// 				}
//
// 				for(int i = 0; i < 51 ; i++) {
// 					REQUIRE(new_list_51.item_at(i) == i);
// 				}
// 			}
// 		}
//
// 		WHEN("Pushing to the origional lists") {
// 			og_list_0.push_back(0);
// 			og_list_50.push_back(50);
// 			og_list_51.push_back(51);
// 			THEN("New lists are not changed") {
//
// 				REQUIRE(new_list_0.length() == 0);
//
// 				for(int i = 0; i < 50 ; ++i) {
...
// 		}
//
// 		WHEN("Pushing to the new lists") {
// 			THEN("Origional lists are not changed") {
//
// 				REQUIRE(og_list_0.length() == 1);
//
// 				REQUIRE(og_list_50.length() == 51);
// 				for (int i = 0; i < 51; ++i) {
// 					REQUIRE(og_list_50.item_at(i) == i);
// 				}
//
// 				REQUIRE(og_list_51.length() == 52);
// 				for (int i = 0; i < 52; ++i) {
// 					REQUIRE(og_list_51.item_at(i) == i);
// 				}
//
// 			}
// 			THEN("New lists do reflect changes") {
// 				REQUIRE(new_list_0.length() == 0);
//
// 				for(int i = 0; i < 50 ; ++i) {
// 					REQUIRE(new_list_50.item_at(i) == i);
